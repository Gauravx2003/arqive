...
const Card = ({ file }: { file: Models.Document }) => {
  ...
  console.log("USER IN CARD: ", currentUser);

  return (
    <Link
      href={file.url}
      target="_blank"
      className="file-card group relative overflow-hidden z-0"
    >
      ...
      <div className="relative p-3 h-full transform transition-all duration-300 group-hover:scale-[1.02] group-hover:-translate-y-1 z-10">
        {/* Header section */}
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex flex-col items-end space-y-3 relative z-20">
